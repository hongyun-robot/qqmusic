                  ...
                  children: [
                      ...
                      onTap: () {
                        if (state is UserLoginState) {
                          if (state.isLogin) {
                            GoRouter.of(
                              context,
                            ).push('/${ROUTER_NAME.recommend.name}');
                    ...
                    TextIcon(
                      ...
                      onTap: () {
                        GoRouter.of(
                          context,
                        ).pushNamed(ROUTER_NAME.musichall.name);
                        var state = GoRouter.of(context).state;
                        routeHistoryObserver.didPush(state);
                      },
                    ),
                  ...
                  children: [
                      ...
                      if (state.isLogin)
                        TextIcon2(
                          ...
                          onTap: () {
                            GoRouter.of(
                              context,
                            ).pushNamed(ROUTER_NAME.like.name);
                            var state = GoRouter.of(context).state;
                            routeHistoryObserver.didPush(state);
                          },
                        ),
                    ...
                    TextIcon2(
                      ...
                      onTap: () {
                        GoRouter.of(
                          context,
                        ).pushNamed(ROUTER_NAME.recently.name);
                        var state = GoRouter.of(context).state;
                        routeHistoryObserver.didPush(state);
                      },
                    ),
                      ...
                      if (state.isLogin)
                        TextIcon2(
                          ...
                          onTap: () {
                            GoRouter.of(
                              context,
                            ).pushNamed(ROUTER_NAME.purchased.name);
                            var state = GoRouter.of(context).state;
                            routeHistoryObserver.didPush(state);
                          },
                        ),
